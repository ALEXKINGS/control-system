%/*************************************************************************************
% *  File Name                                :   Second_derivativel_Element.m
% 
...
%                                                         Bode Diagram And Nyquist  Diagram of Second_derivativel_Element  
...
for t=1:1:len(2)
    nG1(t,:)=[K1(t),K2(t),K3]       %transfer function's thedenominator
...
figure(1); 
title('Nyquist Diagram:Second_derivativel element');
xlabel('real part ');
ylabel('imaginary part');
%Complete Setting

for t=1:1:len(2)
    axis([-1,2,0,3]);                                    %sets scaling for the x- and y-axeson the current plot
    grid on;
...
%Set Bode Diagram params
%Add Bode diagram to Second_derivativel-Element
